...
const expCards = [
  {
    ...
    responsibilities: [
      ...
      "Contributed to system performance improvements, increasing reliability and efficiency.",
    ],
  },
  {
    ...
    responsibilities: [
      ...
      "Supported backend API development and integration with frontend modules.",
    ],
  },
];
